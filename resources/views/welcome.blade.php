...
@section('content')
    ...
    <!-- Hero Section -->
    <div class="relative mb-24" id="inicio">
        <!-- Container with overflow-hidden for the background image -->
        <div class="relative h-[600px] md:h-[800px] w-full rounded-3xl overflow-hidden bg-cover bg-[center_top] flex flex-col justify-center"
            style='background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.6) 0%, rgba(0, 0, 0, 0.2) 60%), url("{{ $settings['hero_image'] ?? '/images/branding/hero.png' }}");'>
            <div class="p-10 md:p-20 text-center">
                ...
                <div class="text-white text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed drop-shadow-md hero-no-filter">
        ...
        <div class="flex flex-col lg:flex-row items-center gap-16">
            <div class="w-full lg:w-1/2">
                <div class="relative rounded-[3rem] overflow-hidden aspect-[4/3] shadow-2xl">
                    ...
                    <div class="absolute bottom-10 left-10" style="color: {{ $settings['cafe_text_color'] ?? '#ffffff' }}">
                        @php
    ...
    @if($carouselImages && $carouselImages->count() > 0)
        <section class="mb-0 scroll-mt-24 overflow-hidden px-4 md:px-0" id="galeria-destacada">
            <div class="max-w-6xl mx-auto mb-10 text-center md:text-left">
                ...
                <h2 class="text-3xl md:text-5xl font-black mt-4 tracking-tight drop-shadow-sm text-slate-800 dark:text-white">
                ...
                <form action="{{ route('bookings.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="name" placeholder="{{ __('Ej. Juan Pérez') }}"
