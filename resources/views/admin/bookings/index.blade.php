...
@section('content')
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
        <div class="flex flex-col gap-1">
            <h1 class="text-[#0d141b] dark:text-white text-3xl font-black leading-tight tracking-[-0.033em]">Reservas Recibidas</h1>
            <p class="text-[#4c739a] dark:text-slate-400 text-base font-normal">Visualiza las solicitudes de reserva desde el formulario web.</p>
        </div>
    </div>
