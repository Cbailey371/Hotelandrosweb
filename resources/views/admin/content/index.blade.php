        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <form action="{{ route('admin.content.update') }}" method="POST" enctype="multipart/form-data" id="builder-form"
                ...
                <input type="hidden" name="active_section" id="active_section"
                    value="{{ session('active_section', 'hero') }}">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <button type="button" onclick="openMediaLibrary('hero_image', 'hero-preview')"
                                            class="bg-white/20 hover:bg-white/40 backdrop-blur-md text-white px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center gap-2">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div>
                                    <div class="flex items-center justify-between mb-2">
                                        <label
                                            class="block text-[11px] font-black text-slate-400 uppercase tracking-wider">Overlay
                                            Color (Shadow)</label>
                                        <div class="flex items-center">
                                            <input type="hidden" name="hero_overlay_enabled" value="0">
                                            <label class="relative inline-flex items-center cursor-pointer">
                                                <input type="checkbox" name="hero_overlay_enabled" value="1"
                                                    class="sr-only peer" {{ ($settings['hero_overlay_enabled'] ?? '1') == '1' ? 'checked' : '' }}>
                                                <div
                                                    class="w-8 h-4 bg-slate-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-3 after:w-3 after:transition-all peer-checked:bg-primary">
                                                </div>
                                            </label>
                                        </div>
                                    </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            window.switchSection = function (sectionId) {
                ...
                const activeInput = document.getElementById('active_section');
            ...
            document.addEventListener('DOMContentLoaded', function () {
                // 1. Prioridad: Sección devuelta por el servidor (Validation/Save)
                const serverSection = document.getElementById('active_section').value;
                if (serverSection && serverSection !== 'hero') {
                    switchSection(serverSection);
                } else {
                    // 2. Fallback: SessionStorage (Manual Reload)
